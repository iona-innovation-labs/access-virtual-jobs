    ...
    if (existingProfile) {
      ...
      const profile = await db
        ...
        .values({
          ...
          hasPaypal: body.hasPaypal || "no",
          numberOfChildren: body.numberOfChildren || "0",
          internetProvider: body.internetProvider || "",
          numberOfMonitors: body.numberOfMonitors || "1",
          numberOfExperience: body.numberOfExperience || "0",
          salaryUnit: body.salaryUnit || "hourly",
          desiredSalary: body.desiredSalary?.toString() || "0",
          howHear: body.howHear || null,

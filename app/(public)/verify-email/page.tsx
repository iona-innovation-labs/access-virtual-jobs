      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center">
          <div className="mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4 tracking-tight">Verification Failed</h1>
            <p className="text-gray-600 text-xl leading-relaxed max-w-sm mx-auto">The verification link is invalid or has expired</p>
          </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-6 border border-red-100/60 max-w-sm mx-auto">
              <div className="flex items-start space-x-4">
                ...
                <div className="text-left">
                  <p className="text-red-700 font-semibold mb-2">Link Expired</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 tracking-tight">Email Verified!</h1>
          <p className="text-gray-600 text-xl leading-relaxed max-w-sm mx-auto">Your account is now ready to use</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <AutoRedirect redirectTo={session?.user?.email ? "/app/overview" : "/login"} delay={5} />
        </div>
      </div>
    </div>
  );

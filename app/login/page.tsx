import { CircleEllipsisIcon, GalleryVerticalEnd } from "lucide-react"
  ...
  return (
    <div className="bg-blue-50 flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
      <div className="flex w-full max-w-sm flex-col gap-6">
        <a href="/" className="flex items-center gap-2 self-center font-medium text-blue-900 hover:text-blue-900 transition-colors">

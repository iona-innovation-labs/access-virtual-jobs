  ...
  return (
    <Card className="p-6 shadow-md border-none rounded-lg w-full max-w-6xl mx-auto">
      ...
      <div className="flex gap-2 mb-4">
        <Badge variant="destructive" className="shadow-medium">
          Top 5% of responders
        </Badge>
        <Badge variant="destructive" className="shadow-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        ...
        <CardContent className="p-4 rounded-lg border">
          ...
          <p className="text-blue-500 cursor-pointer">
            {mockCompanies[0].website}
          </p>
          <p>
            <strong>Location:</strong> {mockCompanies[0].location}
          </p>
          <p>
            <strong>Total Raised:</strong> {mockCompanies[0].totalRaised}
          </p>
          <p>
            <strong>Company Size:</strong> {mockCompanies[0].companySize}
          </p>

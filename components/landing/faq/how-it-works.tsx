...
import { UserPlus, ShieldCheck, Briefcase, Home } from "lucide-react";
    ...
    <section className="py-16 px-6 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2
            className="text-5xl font-bold mb-4 text-[#042e67]"
          ...
          >
            ...
            opportunities and earn a living.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-center mb-6 items-center gap-3">
                  <div
                    className="w-8 h-8 bg-[#042e67] text-white rounded-full flex items-center justify-center text-sm font-semibold"
                ...
                {/* Content */}
                <h3
                  className="text-xl font-semibold mb-3 text-[#042e67]"
                  style={{ fontFamily: "Montserrat, sans-serif" }}
                >
                  {step.title}
                </h3>

...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! We provide comprehensive support through our help center, live chat, and email support. Our team is here to help you succeed in finding and maintaining remote employment.",
  },
  {
    question: "How do I know if a job posting is legitimate?",
    answer:
      "All employers on our platform go through a verification process. We also provide tips and guidelines to help you identify legitimate opportunities and avoid potential scams.",
  },
  {
    question: "Can I work for multiple employers at the same time?",
    answer:
      "This depends on the specific terms of each job and employer. Many remote positions allow for flexible scheduling, but always check the employment terms and communicate with employers about your availability.",
  },
];

    ...
    <section className="bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-2xl mx-auto grid gap-4 sm:gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 lg:max-w-none items-start" data-aos="fade-in">
            {services.map((service, idx) => (
              <div key={idx} className="h-full flex flex-col">
                ...
                <div className="grow text-center">
                  <a className="font-monstserrat text-xs text-gray-100 hover:text-blue-500 transition duration-150 ease-in-out" href="#0">
                    {service.label}
                  </a>
                </div>
              </div>

    ...
    <footer className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 lg:grid-cols-10 gap-8 py-8 border-t border-blue-500">
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-xs text-gray-100 font-bold uppercase mb-3">Tools</h6>
            <ul className="text-sm space-y-2">
              <li>
                <a className="text-blue-300 hover:text-white transition duration-150 ease-in-out" href="#0">
                  For Talents
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li>
                <a className="text-blue-300 hover:text-white transition duration-150 ease-in-out" href="/legal/terms-of-services">
                  Terms of service
                </a>
              </li>
              <li>
                <a className="text-blue-300 hover:text-white transition duration-150 ease-in-out" href="/legal/privacy-policy">
                  Privacy policy
                </a>
              </li>
            </ul>
        ...
        <div className="md:flex md:items-center md:justify-between pb-4 md:pb-8">
          ...
          {/* Copyrights */}
          <div className="text-sm text-blue-300">© 2024 - 2025 Access Virtual Staffing. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )

...
export default function Faqs() {
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-12" data-aos="fade-right">
        <div className="pb-12 md:pb-20">
          <div className="max-w-3xl mx-auto pb-10">
            <h2 className="font-archivo text-xl md:text-3xl font-bold text-black">{landingPage.faqs.title}</h2>
          </div>
